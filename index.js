...
const description = `
        A total of $${totalAmountRaised.toLocaleString()} has been raised for ${GAMES_JSON.length}
        games. Currently, ${numUnfundedGames} ${numUnfundedGames == 1 ? "game remains" : "games remain"} 
        unfunded. We need yout help to fund these amazing games!
`;       
